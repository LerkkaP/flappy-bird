...
class PipeMovement:
    ...
    def _add_pipe(self, x, y, is_top):
        self.pipe.add(Pipe(self.speed, self.screen_width, self.screen_height, x, y, is_top))
    ...
    def update_pipe(self):
        ...
        if last_pipe.rect.left == 320:
            self._add_pipe(self.screen_width, self.bottom_pipe_y, False)
            self._add_pipe(self.screen_width, self.top_pipe_y, True)
