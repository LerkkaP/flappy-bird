...
class TestPipe(unittest.TestCase):
    ...
    def test_if_score_is_updated_correctly(self):
        pipe_bottom = Pipe(speed, screen_width, screen_height, screen_width / 3 + 20, pipe_initial_y, False)
        pipe_top = Pipe(speed, screen_width, screen_height, screen_width / 3 + 20, pipe_initial_y - 320 - self.pipe_movement.pipe_difference, True)
